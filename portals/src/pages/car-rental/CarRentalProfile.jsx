...
export default function CarRentalProfile() {
  ...
  if (profileQuery.isLoading && !hydrated) {
    return <p className="text-sm text-gray-500">Loading company profile…</p>;
  }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Business details and branding for your car rental fleet."
      />
      ...
      <Card title="Branding">
        <div className="space-y-6">
          <ImageSingleField
            label="Cover image"
            hint="Wide banner for your rental company presence."
            aspect="cover"
            ...
            onUpload={(file) => inventoryService.uploadCarRentalImage(file, "cover")}
          />
          <div className="max-w-xs">
            <ImageSingleField
              ...
              onUpload={(file) => inventoryService.uploadCarRentalImage(file, "logo")}
            />
          </div>
        </div>
      </Card>
