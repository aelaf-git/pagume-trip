...
export const MOCK_DRIVER_CALENDAR = [
  { date: "2026-08-18", type: "booked", label: "Northern Circuit — Sarah M.", bookingId: "BK-1001" },
  { date: "2026-08-19", type: "booked", label: "Northern Circuit — Sarah M.", bookingId: "BK-1001" },
  { date: "2026-08-20", type: "booked", label: "Northern Circuit — Sarah M.", bookingId: "BK-1001" },
  { date: "2026-08-22", type: "off", label: "Personal Leave" },
  { date: "2026-08-23", type: "off", label: "Personal Leave" },
  { date: "2026-08-25", type: "booked", label: "Lake Tana Day Trip — Fatima H.", bookingId: "BK-1004" },
  { date: "2026-08-27", type: "blocked", label: "Vehicle maintenance" },
  { date: "2026-08-28", type: "blocked", label: "Vehicle maintenance" },
  { date: "2026-09-01", type: "booked", label: "Danakil Explorer — James O.", bookingId: "BK-1006" },
  { date: "2026-09-02", type: "booked", label: "Danakil Explorer — James O.", bookingId: "BK-1006" },
  { date: "2026-09-03", type: "booked", label: "Danakil Explorer — James O.", bookingId: "BK-1006" },
  { date: "2026-09-04", type: "booked", label: "Danakil Explorer — James O.", bookingId: "BK-1006" },
  { date: "2026-09-10", type: "off", label: "Personal Leave" },
  { date: "2026-09-15", type: "booked", label: "Historic Lalibela — Yuki T.", bookingId: "BK-1009" },
  { date: "2026-09-16", type: "booked", label: "Historic Lalibela — Yuki T.", bookingId: "BK-1009" },
  { date: "2026-09-17", type: "booked", label: "Historic Lalibela — Yuki T.", bookingId: "BK-1009" },
];

export const MOCK_DRIVER_ASSIGNMENTS = [
  {
    id: "asgn-1",
    bookingId: "BK-1001",
    ...
    status: "in_progress",
    preparation: [
      { step: "Confirm hotel bookings", done: true },
      { step: "Arrange vehicle inspection", done: true },
      { step: "Print itinerary copies", done: true },
      { step: "Contact client for pickup time", done: true },
      { step: "Stock water and snacks", done: false },
      { step: "Check first-aid kit", done: false },
    ],
  },
  {
    id: "asgn-2",
    ...
    tourType: "Day Trip",
    route: "Bahir Dar \u2192 Lake Tana Monasteries \u2192 Blue Nile Falls",
    startDate: "2026-08-25",
    endDate: "2026-08-25",
    income: 6500,
    status: "upcoming",
    preparation: [
      { step: "Confirm boat rental", done: true },
      { step: "Print itinerary copies", done: false },
      { step: "Contact client for pickup time", done: false },
      { step: "Stock water and snacks", done: false },
    ],
  },
  {
    ...
    route: "Mekelle \u2192 Dodom \u2192 Erta Ale \u2192 Dallol",
    startDate: "2026-09-01",
    endDate: "2026-09-04",
    income: 32500,
    status: "upcoming",
    preparation: [
      { step: "Confirm camping gear rental", done: true },
      { step: "Arrange vehicle inspection", done: true },
      { step: "Verify park entrance fees paid", done: false },
      { step: "Print itinerary copies", done: false },
      { step: "Contact client for pickup time", done: false },
      { step: "Stock water and snacks", done: false },
      { step: "Check first-aid kit", done: false },
      { step: "Charge phone and backup battery", done: false },
    ],
  },
  {
    id: "asgn-4",
    ...
    route: "Addis Ababa \u2192 Lalibela \u2192 Axum \u2192 Gondar",
    startDate: "2026-09-15",
    endDate: "2026-09-21",
    income: 28000,
    status: "upcoming",
    preparation: [
      { step: "Confirm hotel bookings", done: false },
      { step: "Arrange vehicle inspection", done: false },
      { step: "Print itinerary copies", done: false },
      { step: "Contact client for pickup time", done: false },
      { step: "Stock water and snacks", done: false },
      { step: "Verify park entrance fees paid", done: false },
  ...
  },
  {
    ...
    preparation: [
      ...
      { step: "Print itinerary copies", done: true },
      { step: "Contact client for pickup time", done: true },
      { step: "Stock water and snacks", done: true },
    ],
  },
];
